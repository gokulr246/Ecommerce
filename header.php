	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="left">
					<ul>
					<a href="tel:<?php echo $contact_phone; ?>"><li><i class="fa fa-phone"></i> <?php echo $contact_phone; ?></li></a>
					<a href="mailto:<?php echo $contact_email; ?>"><li><i class="fa fa-envelope-o"></i> <?php echo $contact_email; ?></li></a>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
