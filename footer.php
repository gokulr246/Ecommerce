...
<div class="footer-nav">
		<div class="container ">
			...
			<div class="footer-nav__col footer-nav__col--whybuy">
				<div class="footer-nav__heading">Most Selling</div>
				<ul class="footer-nav__list">
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Wooden Doors</a>
					</li>
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Veneer Doors</a>
					</li>
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Teapoy</a>
					</li>
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Dining Table</a>
					</li>
				</ul>
			</div>
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="customer-order.php" class="footer-nav__link">Track an order</a>
					</li>
					<li class="footer-nav__item">
						<a href="customer-billing-shipping-update.php" class="footer-nav__link">Update information</a>
					</li>
				</ul>
			</div>
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office:Sri Nature Furnitures & Doors.<br>
				A1, Sri Nature Furniture and Doors, Thally Hudco, Thally Road, Hosur, Krishnagiri, Hosur-635109, Tamil Nadu, India.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:+91 99444 42243">+91 99444 42243</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:rajtimber2007@gmail.com" class="email__addr">rajtimber2007@gmail.com</a>
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 copyright">
				<h6>Copyright Â© 2023 - Sri Nature Furniture And Doors - Developed By RAM</h6>
			</div>
		</div>
	</div>
</div>
